...
This outlines how to propose a change to osrm.backend. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("e-kotov/osrm.backend", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://www.ekotov.pro/osrm.backend/CODE_OF_CONDUCT.md). By
