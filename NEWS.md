...
* Switched binary integrity verification to dynamically fetch `checksums.txt` from GitHub release assets on-the-fly, ensuring installation security without requiring R package updates when new binary builds are released.
